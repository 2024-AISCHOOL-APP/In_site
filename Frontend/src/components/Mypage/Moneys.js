...
const Moneys = () => {
  ...
  return (
    <Container>
      <Row className='mt-4'>
        <Col className='my-3'>
          {/* <Button className='me-5' style={{backgroundColor:'#DAC4FB',border:"none",color:'black'}}>기록</Button>
          <Button style={{backgroundColor:'#DAC4FB',border:"none",color:'black'}}>차트</Button>              */}
        </Col>
      </Row>
      <Row>
        <Tabs
