  ...
  const navigateTo = useCallback((path) => navigate(path), [navigate]);
    ...
    return (
        <Nav justify variant="tabs"  className='custom-snavbarmy' >
          ...
          <Nav.Item>
            <Nav.Link  className='navlinkmy' onClick={() => navigateTo("/Mypage/moneys")}>가계부</Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link  className='navlinkmy' onClick={() => navigateTo("/Mypage/Sbasket")}>장바구니</Nav.Link>
          </Nav.Item>
        </Nav>
      );
    }
